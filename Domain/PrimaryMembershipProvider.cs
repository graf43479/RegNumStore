...
namespace Domain
{
    public class PrimaryMembershipProvider : MembershipProvider
    {
        ...
        public MembershipCreateStatus CreateUser(string login, string password, string email, string phone, string userName, bool isActivated, string passwordSalt, int userRoleId)
        {
            ...
            usersRepository.CreateUser(login, password, email, phone, userName, isActivated, passwordSalt, userRoleId);
        ...
        public override bool ValidateUser(string login, string password)
        {
            ...
            return usersRepository.ValidateUser(login, password);
        }
